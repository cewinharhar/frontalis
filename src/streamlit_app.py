...
async def main() -> None:
    ...
    if len(messages) == 0:
        match agent_client.agent:
            ...
            case "transcriptomics-expert":
                WELCOME = "Hello! I'm an AI-powered transcriptomics assistant with advanced file downloading and analysis tools. Ask me anything!"
            case "rag-assistant":
